...
@section('title', trans('admin.market'))
@section('content')
    <div class="row">
        <div class="col-md-12">
            <div class="iq-card">
                <a href="{{ route('markets.create') }}" class="btn btn-text-primary font-weight-bold btn-fixed"
                    data-palcement="top" data-toggle="tooltip" title="{{ trans('admin.add-market') }}">
                    ...
                    <table class="table table-striped table-bordered mt-4 table-hover text-center datatable-example"
                        ...
                        <thead>
                            <tr>
                                ...
                                <th>{{ trans('admin.number_company') }}</th>
                                <th>{{ trans('admin.phone') }}</th>
                                <th>{{ trans('admin.address') }}</th>
                                <th>{{ trans('admin.email') }}</th>
                                <th>{{ trans('admin.web_site') }}</th>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if ($item->images->count() > 0)
                                            <img src="{{ $item->images->pop()->path }}" style="width:40px;height:40px;" />
                                        @else
                                    ...
                                    <td class="text-center">
                                        <div class="flex align-items-center list-user-action">
                                            <a class="iq-bg-primary" data-toggle="tooltip" data-placement="top"
                                                ...
                                                href="{{ route('markets.edit', $item->id) }}">
                                                <i class="ri-pencil-line"></i>
                                            </a>
                                            <a class="iq-bg-primary" data-toggle="tooltip" data-placement="top"
                                                title="{{ trans('admin.show') }}" data-original-title="Edit"
                                                href="{{ route('markets.show', $item->id) }}">
                                                ...
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer">
                                                            ...
                                                            {!! Form::open(['method' => 'delete', 'route' => ['markets.destroy', $item->id], 'class' => 'd-inline']) !!}
