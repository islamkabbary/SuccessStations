...
<div class="row">
    <div class="col-md-12">
        <div class="iq-card">
            <a href="{{route('services.create')}}" class="btn btn-text-primary font-weight-bold btn-fixed" data-palcement="top" data-toggle="tooltip" title="{{trans('admin.add-service')}}">
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <div class="flex align-items-center list-user-action">
                                        <a class="iq-bg-primary" data-toggle="tooltip" data-placement="top" title="{{trans('admin.edit')}}" data-original-title="Edit" href="{{route('services.edit' , $item->id)}}">
                                            ...
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-footer">
                                                        ...
                                                        {!! Form::open(['method'=>'delete' , 'route'=>['services.destroy' ,$item->id] , 'class'=>'d-inline']) !!}
