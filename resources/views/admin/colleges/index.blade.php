...
@section('title', trans('admin.colleges'))
@section('content')
    <div class="row">
        <div class="col-md-12">
            <div class="iq-card">
                <a href="{{ route('colleges.create') }}" class="btn btn-text-primary font-weight-bold btn-fixed"
                    data-palcement="top" data-toggle="tooltip" title="{{ trans('admin.add-college') }}">
                    <i class="fa fa-plus"></i>
                </a>
                <div class="iq-card-header d-flex justify-content-between">
                    <div class="iq-header-title">
                        <h4 class="card-title">
                            {{ trans('admin.colleges') }}
                        </h4>
                    </div>
                </div>
                <div class="iq-card-body">
                    ...
                    <table class="table table-striped table-bordered mt-4 table-hover text-center datatable-example"
                        ...
                        <tbody>
                            @foreach ($colleges as $index => $item)
                                <tr>
                                    <td>{{ $index + 1 }}</td>
                                    <td>{{ $item->name }}</td>
                                    ...
                                    <td class="text-center">
                                        <div class="flex align-items-center list-user-action">
                                            <a class="iq-bg-primary" data-toggle="tooltip" data-placement="top"
                                                ...
                                                href="{{ route('colleges.edit', $item->id) }}">
                                                ...
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer">
                                                            ...
                                                            {!! Form::open(['method' => 'delete', 'route' => ['colleges.destroy', $item->id], 'class' => 'd-inline']) !!}
